    ...
    <div class="app-header__container container">
      ...
      <nav>
        <ul class="app-header__links">
          <li>
            <a href="https://twitter.com/warrendadev" class="nav-link">
              <svg
                ...
                height="24"
                fill="currentColor"
                class="bi d-block mx-auto mb-1 bi-twitter"
                viewBox="0 0 16 16"
              >
                <path
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/warren-scantlebury-581358190/"
              class="nav-link"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                height="24"
                fill="currentColor"
                class="bi d-block mx-auto mb-1 bi-linkedin"
                viewBox="0 0 16 16"
              >
                <path
          ...
          <li>
            <a href="https://github.com/warren488" class="nav-link">
              <svg
                ...
                height="24"
                fill="currentColor"
                class="bi d-block mx-auto mb-1 bi-github"
                viewBox="0 0 16 16"
              >
                <path
